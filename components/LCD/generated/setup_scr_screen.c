...
int screen_Time_min_value = 25;
int screen_Time_hour_value = 11;
int screen_Time_sec_value = 50;
char screen_Time_meridiem[] = "AM";
void setup_scr_screen(lv_ui *ui)
{
    ...
    static bool screen_Time_timer_enabled = false;
    ui->screen_Time = lv_label_create(ui->screen);     // 创建 Label
    lv_label_set_text(ui->screen_Time, "11:25:50 AM"); // 初始文本
    if (!screen_Time_timer_enabled) {
        lv_timer_create(screen_Time_timer, 1000, NULL);
        screen_Time_timer_enabled = true;
    }
    lv_obj_set_pos(ui->screen_Time, 27, 38);
    lv_obj_set_size(ui->screen_Time, 272, 66);

    //Write style for screen_Time, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_radius(ui->screen_Time, 24, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_Time, lv_color_hex(0x2F92DA), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_Time, &lv_font_Acme_Regular_44, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_Time, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_Time, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui->screen_Time, 12, LV_PART_MAIN|LV_STATE_DEFAULT);
